...
if(sensorValue > 550){
  ...
  if (client.connect("maker.ifttt.com",80)) {
    MakerIFTTT_Key ="e9VFXNnTZr2McEe_M0u0j8l_EUul5TAD7PWoezFp45A";
    ...
    p = append_str(p, "in danger");
    p = append_str(p, "\",\"value3\":\"");
    p = append_str(p, "192.168.23.160");
    p = append_str(p, "\"}");
